...
export default function Hero() {
  return (
    <section className="relative flex flex-col justify-center items-center px-4 sm:px-8 md:px-16 h-screen text-xl sm:text-2xl md:text-3xl font-light text-black">
      ...
      <a
        href="https://www.phantasia.tech/"
        target="blank"
        className="absolute bottom-12 sm:bottom-16 md:bottom-24 w-fit px-12 sm:px-20 md:px-32 bg-phantasia-blue text-2xl sm:text-3xl md:text-4xl rounded-xl sm:rounded-2xl p-2 font-medium cursor-pointer inline-block"
      >
        Register Now
      </a>
    </section>
